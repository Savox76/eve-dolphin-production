...
CATALOG: dict[str, dict[str, str]] = {
    "de": {
        ...
        "pi_mode_extractor": "Extraktor-Kolonie",
        "pi_mode_import": "Zukauf-/Launchpad-Kolonie",
        "pi_countdown_extractor": "Extraktoren laufen noch {remaining}",
        "pi_countdown_supply": "Eingangsmaterial reicht noch {remaining}",
        "pi_countdown_unknown": "Keine verlässliche Restlaufzeit berechenbar",
        "pi_storage_pin": "Lager / Launchpad",
        "pi_storage_contents": "Inhalt",
        "pi_storage_volume": "Volumen",
        "pi_storage_fill": "Füllstand",
        ...
        "pi_warning_extractors_ending_soon": "Extraktor endet binnen 10 Stunden",
        "pi_warning_supply_ending_soon": "Eingangsmaterial reicht weniger als 10 Stunden",
        "pi_warning_supply_depleted": "Eingangsmaterial aufgebraucht",
        ...
        "pi_input_fill_column": "Gesamtbelegung",
        "pi_input_launchpad_value": "Eingang {index}",
        "pi_input_fill_value": "{used} / {capacity} m³",
        "pi_production_path_title": "Produktionsweg vom Startprodukt zum Ziel",
        "pi_output_launchpad_title": "Ergebnis im Ausgangs-Launchpad",
        "pi_output_launchpad_column": "Ausgang",
        "pi_output_launchpad_value": "Ziel-Launchpad",
        "pi_output_free_column": "Restplatz",
        "pi_output_duration_column": "Produktionsdauer",
        ...
        "pi_storage_strategy": "Zwischenlager",
        "pi_storage_strategy_direct": "Direkte Routen ohne Zwischenlager",
        "pi_storage_strategy_buffered": "Pufferlager zwischen Produktionsstufen",
        "pi_saved_plan": "Gespeicherte Planung",
        "pi_plan_unsaved": "Neue / ungespeicherte Planung",
        "pi_plan_name": "Name der Planung",
        "pi_plan_new": "Neu",
        "pi_plan_save": "Planung speichern",
        "pi_plan_delete": "Planung löschen",
        "pi_plan_saved": "PI-Planung gespeichert: {name}",
        "pi_plan_deleted": "PI-Planung wurde gelöscht.",
        "pi_plan_save_error": "PI-Planung konnte nicht gespeichert werden: {message}",
        ...
        "pi_diagram_input_launchpad": "Eingangs-Launchpad",
        "pi_diagram_extractor": "Extraktor",
        "pi_diagram_ecu": "ECU",
        ...
        "pi_layout_output_day": "Ausgang/Tag",
        "pi_layout_buffer": "Materialfluss",
        "pi_layout_storage_required": "Pufferlager",
        "pi_layout_direct_route": "Direktroute / Launchpad",
    ...
    "en": {
        ...
        "pi_mode_extractor": "Extractor colony",
        "pi_mode_import": "Purchased-input / launchpad colony",
        "pi_countdown_extractor": "Extractors have {remaining} remaining",
        "pi_countdown_supply": "Input material lasts another {remaining}",
        "pi_countdown_unknown": "No reliable remaining runtime can be calculated",
        "pi_storage_pin": "Storage / launchpad",
        "pi_storage_contents": "Contents",
        "pi_storage_volume": "Volume",
        "pi_storage_fill": "Fill level",
        ...
        "pi_warning_extractors_ending_soon": "extractor ends within 10 hours",
        "pi_warning_supply_ending_soon": "input material lasts less than 10 hours",
        "pi_warning_supply_depleted": "input material depleted",
        ...
        "pi_input_fill_column": "Total fill",
        "pi_input_launchpad_value": "Input {index}",
        "pi_input_fill_value": "{used} / {capacity} m³",
        "pi_production_path_title": "Production path from starting product to target",
        "pi_output_launchpad_title": "Result in the output launchpad",
        "pi_output_launchpad_column": "Output",
        "pi_output_launchpad_value": "Target launchpad",
        "pi_output_free_column": "Free space",
        "pi_output_duration_column": "Production time",
        ...
        "pi_storage_strategy": "Intermediate storage",
        "pi_storage_strategy_direct": "Direct routes without intermediate storage",
        "pi_storage_strategy_buffered": "Buffer storage between production tiers",
        "pi_saved_plan": "Saved plan",
        "pi_plan_unsaved": "New / unsaved plan",
        "pi_plan_name": "Plan name",
        "pi_plan_new": "New",
        "pi_plan_save": "Save plan",
        "pi_plan_delete": "Delete plan",
        "pi_plan_saved": "PI plan saved: {name}",
        "pi_plan_deleted": "PI plan was deleted.",
        "pi_plan_save_error": "PI plan could not be saved: {message}",
        ...
        "pi_diagram_input_launchpad": "Input launchpad",
        "pi_diagram_extractor": "Extractor",
        "pi_diagram_ecu": "ECU",
        ...
        "pi_layout_output_day": "Output/day",
        "pi_layout_buffer": "Material flow",
        "pi_layout_storage_required": "Buffer storage",
        "pi_layout_direct_route": "Direct route / launchpad",
