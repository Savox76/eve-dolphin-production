...
Phase 1 ist abgeschlossen. Phase 2 läuft: Der abgesicherte EVE-SSO-/PKCE-Kern, der lokale Einmal-Callback, die JWT-Prüfung und die transaktionale lokale Verwaltung mehrerer Charaktere sind implementiert. Unter „Einstellungen & Charaktere“ steht die sichtbare, nicht blockierende Browser-Anmeldung mit lokalem Berechtigungsstatus und sicherem Trennen bereit. Der Refresh-Kern ersetzt rotierte Tokens und erkennt widerrufene Freigaben. Die aktuelle offizielle JSON-Lines-SDE kann gecacht heruntergeladen, geprüft, versioniert und atomar mit Blueprints sowie PI-Schematics importiert werden. Der gemeinsame ESI-Transport respektiert Kompatibilitätsdatum, Cachezeiten, bedingte Anfragen, Wiederholungsgrenzen und beide aktuellen ESI-Limitsysteme. Persönliche Assets und Blueprints können bereits vollständig mehrseitig geladen und gemeinsam als atomarer, charaktergetrennter Snapshot gespeichert werden. Industry Jobs, Planeten und die sichtbare Datenstatus-Anbindung bleiben Teil dieses Meilensteins; deshalb bleibt der abgenommene Gesamtfortschritt bei `15 %`.
